...
import { createContentManagerLesson } from "@/services/content-manager";

export default function CreateContentManagerLessonPage() {
  ...
  async function handleSubmit(
    ...
    try {
      ...
      await createContentManagerLesson(
        token,
        courseDocumentId,
        title.trim(),
        lessonContent,
      ...
      router.push(
        `/content-manager/courses/${courseDocumentId}/lessons`,
      );
    } catch (error: unknown) {
      console.error(error);
