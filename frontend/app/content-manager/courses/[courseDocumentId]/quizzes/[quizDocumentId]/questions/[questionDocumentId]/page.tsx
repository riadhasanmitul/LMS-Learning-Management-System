...
import {
  updateContentManagerQuestion,
  type ContentManagerQuestion,
} from "@/services/content-manager";
import { api } from "@/lib/api";

export default function EditContentManagerQuestionPage() {
  ...
  const [item, setItem] =
    useState<ContentManagerQuestion | null>(null);
  ...
  async function handleSubmit(
    ...
    try {
      await updateContentManagerQuestion(
        token,
        questionDocumentId,
        question.trim(),
