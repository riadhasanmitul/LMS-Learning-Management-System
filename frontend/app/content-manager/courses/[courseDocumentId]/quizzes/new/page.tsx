...
import { createContentManagerQuiz } from "@/services/content-manager";

export default function CreateContentManagerQuizPage() {
  ...
  async function handleSubmit(
    ...
    try {
      const response = await createContentManagerQuiz(
        token,
        courseDocumentId,
        title.trim(),
      );
