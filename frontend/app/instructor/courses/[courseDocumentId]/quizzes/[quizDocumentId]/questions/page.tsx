  ...
  async function handleDelete(
    ...
    try {
      ...
      setQuestions((current) =>
        current.filter(
          (item) =>
            item.documentId !== questionDocumentId,
        ),
      );
    } catch (error: unknown) {
      if (
    ...
    <main className="min-h-screen bg-slate-50">
      ...
      <div className="mx-auto max-w-6xl px-6 py-8">
        <section className="flex flex-col gap-5 rounded-3xl bg-slate-950 p-8 md:flex-row md:items-center md:justify-between">
          ...
          <Link
            href={`/instructor/courses/${courseDocumentId}/quizzes/${quizDocumentId}/questions/new`}
                ...
                >
                  <div className="flex flex-col gap-5">
                    ...
                    <div className="flex justify-end gap-2">
                      <Link
                        href={`/instructor/courses/${courseDocumentId}/quizzes/${quizDocumentId}/questions/${item.documentId}`}
