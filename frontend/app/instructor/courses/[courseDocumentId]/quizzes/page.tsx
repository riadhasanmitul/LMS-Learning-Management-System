...
export default function InstructorQuizzesPage() {
  ...
  async function handleDelete(quizDocumentId: string) {
    ...
    try {
      await deleteQuiz(token, quizDocumentId);
  ...
  async function handleTogglePublish(quiz: InstructorQuiz) {
    const storedToken = getToken();
    ...
    try {
      if (quiz.publishedAt) {
        await unpublishQuiz(storedToken, quiz.documentId);
      } else {
        await publishQuiz(storedToken, quiz.documentId);
      }
    ...
    <main className="min-h-screen bg-slate-50">
      ...
      <div className="mx-auto max-w-6xl px-6 py-8">
        <section className="flex flex-col gap-5 rounded-3xl bg-slate-950 p-8 md:flex-row md:items-center md:justify-between">
          ...
          <Link
            href={`/instructor/courses/${courseDocumentId}/quizzes/new`}
                ...
                >
                  <div className="flex flex-col gap-4 md:flex-row md:items-center">
                    ...
                    <div className="flex flex-wrap items-center gap-2">
                      ...
                      <Link
                        href={`/instructor/courses/${courseDocumentId}/quizzes/${quiz.documentId}`}
                      ...
                      <Link
                        href={`/instructor/courses/${courseDocumentId}/quizzes/${quiz.documentId}/questions`}
