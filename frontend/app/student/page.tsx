        ...
        <div className="mx-auto flex h-16 max-w-7xl items-center justify-between px-6">
          ...
          <div className="flex items-center gap-2.5 sm:gap-3">
            ...
            <button
              ...
              className="rounded-xl border border-red-200 bg-red-50/50 px-3 py-1.5 text-xs font-semibold text-red-600 transition hover:bg-red-100/60 dark:border-red-900/50 dark:bg-red-950/50 dark:text-red-300"
            >
              Logout
            </button>
          </div>
